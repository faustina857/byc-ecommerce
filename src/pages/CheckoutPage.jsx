...
const CheckoutPage = () => {
  ...
  const handlePlaceOrder = () => {
    // Validation
    if (!shippingInfo.fullName || !shippingInfo.country|| !shippingInfo.town || !shippingInfo.state || 
      !shippingInfo.address || !shippingInfo.phone || !shippingInfo.email || !shippingInfo.landmark) {
      Swal.fire({
        icon:'warning',
