  ...
  return (
    <>
      <div className="container about">
        ...
        <div className="row">
            <div className="col-md-6"><img src={Frame17} alt="" className='w-100 a-image'/></div>
            <div className="col-md-6">
                <h3 className='a-heads'>ABOUT BYC AFRICA</h3>
                <p className='about-p'>
        ...
        <div className="row">
            <div className="col-md-4">
                <div className='about-box shadow-sm' style={{backgroundColor:"#BD3A3A0A",borderRadius:"5px"}}>
                    ...
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700",marginTop:"35px"}}>Year 1990</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                    ...
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700"}}>Year 1993</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                    ...
                    Economists..</p>
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700"}}>Year 1997</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
            ...
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                    ...
                    Industries</p>
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700"}}>Year 1999</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                    ...
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700",marginTop:"35px"}}>Year 2001</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                    ...
                    <p>The Prize for Export of Original Brands awarded as <br />recommended by the Korean Assoiatioon of Textile <br />
                    Industries</p>
                    <h5 className='year' style={{color:"#D7000F",fontWeight:"700"}}>Year 2006</h5>
                </div>
            </div>
            <div className="col-md-4">
                <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
            ...
            <div className="col-md-4">
                    <div className='about-box' style={{backgroundColor:"#FBFBFB",borderRadius:"5px"}}>
                        ...
                        <h5 className='year' style={{color:"#D7000F",fontWeight:"700",marginTop:"35px"}}>Year 2011</h5>
                    </div>
            </div>
        </div>
      </div>
