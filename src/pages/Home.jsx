  ...
  return (
    <>
      <section className='hero-section'>
        <div className='hero text-center'>
            ...
            <div className="frame text-center">
               <img src={Frame1} alt="" />
               <img src={Frame2} alt="" className='m-frame'/>
               <img src={Frame3} alt="" />
            </div>
        </div>
      </section>
      ...
      <div className="container">
        ...
        <div className="row">
        <div className="col-sm-12 col-md-12 col-lg-4 font-jost">
      ...
      <div className="container h-third">
        <div className="row">
            <div className="col-md-6 font-jost">
                <div style={{backgroundColor:"#F1F1F1", width:"100%"}} className='title'>
                    <h3 style={{color:"#616161", fontWeight:"700"}}>BYC Collection 2021</h3>
                    <h2>BYC Collection</h2>
                    <p className='font-lato' style={{color:"#424242"}}>The best everyday option in a Super Saver range within a <br />reasonable price. It is our responsibility to keep you <br />
    ...
    <section className="shop-category text-center">
        <div className="container">
            <h2 className="font-jost">Shop By Category</h2>
            <ul className="nav justify-content-center font-jost">
            <li className="shop-item">
                <a className="shop-link" style={{color:"#000"}} href="#">For Women</a>
            </li>
            <li className="shop-item">
                <a className="shop-link" style={{color:"#000"}} href="#">For Men</a>
            </li>
            <li className="shop-item">
                <a className="shop-link" style={{color:"#000"}} href="#">For Kids</a>
            </li>
            </ul>
        ...
        <div className='n-blog' ><h2 className='text-center font-jost' style={{fontWeight:"700"}}>BYC AFRICA Blog News</h2></div>
    </section>
    <BlogSection />
